...
const loseAGame = new Situation({
    ...
    actions: [`Take a deep breath and count to 5`, `Go to the winning team, and say “good game”`, `You can challenge them to another game. If they don’t want to play again, you need to respect their answer and let it go. You can play again another day.`],
    comment: ''
})
...
const playAGameYouDontWantToPlay = new Situation({
    ...
    actions: [`You can say, “Ok. I pick next.”`, `Even if you are not interested in the game, follow all the rules and try your hardest to play.`, `Even if you think you won’t like a game, you should still fully participate. You may be surprised when you start having fun.`],
    comment: ''
})
...
const siblingWatchingShowYouDontLike = new Situation({
    ...
    actions: [`You can say, “I pick the next show”`, `While the Show is on, you can find something else to do, or you can play on a tablet or phone.`, `Keep the volume down or use headphones so you brother/ sister can watch the TV show`],
    comment: ''
})
...
const lostInAStore = new Situation({
    ...
    actions: [`Pick a meeting place, like the front of the store or the bathrooms.`, `Go to the customer service desk.`, `If you have a phone, call or text your mom or dad.`],
    comment: ''
})
